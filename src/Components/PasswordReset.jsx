...
const PasswordReset = (props) => {
  ...
  const reset = () => {
    auth.sendPasswordResetEmail(inputs.email)
      .then(() => {
        setMessage({ style: 'success', content: `Password Reset Link sent to: ${inputs.email}` });
      }).catch((error) => {
          ...
          <div className="col-lg-12">
            ...
            <form>
              <div className="form-group col-12 mx-auto">
                ...
                <input value={inputs.email || ''} onChange={handleInputChange} type="email" name="email" className="form-control prefinput" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" />
              </div>
              <div className="col-12 d-flex justify-content-center mb-3">
                <button onClick={handleSubmit} type="button" className="btn-primary email-button">
